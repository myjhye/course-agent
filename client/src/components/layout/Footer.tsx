    ...
    <footer className="bg-gray-900 text-gray-400">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold text-white">Course Agent</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to="/lessons" className="hover:text-white transition">강습 둘러보기</Link></li>
              <li><Link to="/my/enrollments" className="hover:text-white transition">내 강습</Link></li>
              <li><Link to="/chat" className="hover:text-white transition">AI 상담</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-sm text-center">
          © 2026 Course Agent. All rights reserved.
        </div>
      </div>
    </footer>
  );
